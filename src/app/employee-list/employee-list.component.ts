...
export class EmployeeListComponent implements OnInit {
  ...
  constructor() {
    this.employees = [
                      ...
                      {code : "emp02",name:'Peter',gender:"Male",annualSalary:600,dateOfBirth:"23/04/2001"},
  ...
  getAllTotalEmployees():number{
    return this.employees.length;
  }
  getMaleTotalEmployees():number{
    return this.employees.filter(e=>e.gender.toLowerCase() === "male").length;
  }
  getFemaleTotalEmployees():number{
